...
export class SolicitarDetallePage {
	...
	private is_chofer = false;
	private is_guia = false;
	...
	constructor(public navCtrl: NavController, public navParams: NavParams, public getDatos: GetDatosProvider, private toastCtrl: ToastController) {
		...
		let usuario = this.getDatos.usr;
		console.log(usuario.tipo_usuario)
		if (usuario.tipo_usuario == 'is_chofer') {
			this.is_chofer = true;
		}else if(usuario.tipo_usuario == 'is_guia'){
			this.is_guia = true;
		}else if(usuario.tipo_usuario == 'is_client'){
			this.is_client = true;
		}else {
			this.is_chofer = true;
			this.is_client = true;
